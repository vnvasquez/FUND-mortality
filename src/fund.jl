...
include("ImpactDeathTempComponent.jl")
...
function constructfund(;nsteps=1050)
    ...
    addcomponent(m, impactdeathtemp, :impactdeathtemp)
    ...
    #connectparameter(m, :population, :dead, :impactdeathtemp, :dead)
    ...
    connectparameter(m, :impactdeathtemp, :temp, :climateregional, :temp)
    ...
    connectparameter(m, :impactdeathmorbidity, :dead_other, :impactdeathtemp, :gcpdead)
    ...
    #connectparameter(m, :impactaggregation, :deadcost, :impactdeathtemp, :deadcost)
